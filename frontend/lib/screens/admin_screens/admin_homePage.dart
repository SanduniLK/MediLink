      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.trending_up, size: 16, color: Colors.white.withOpacity(0.9)),
          ...
          Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.dashboard, size: 18, color: const Color(0xFF18A3B6)),
                const SizedBox(width: 8),
                Text(
                  'Quick Actions',
                  style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(icon, color: color, size: 16), // Smaller icon for 3-column
              ),
...
Widget _buildMiniElegantButton(IconData icon, String label, Color color, VoidCallback onTap) {
  return MouseRegion(
    cursor: SystemMouseCursors.click,
    child: GestureDetector(
      onTap: onTap,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.arrow_forward_rounded, size: 12, color: Colors.grey),
                  ),
                ],
              ),
  ...
  return FutureBuilder(
    ...
    builder: (context, snapshot) {
      ...
      return Container(
        ...
        child: Row(
          children: [
            _buildStatItem('Total Reviews', stats['totalReviews'].toString(), Icons.reviews_rounded, Colors.blue),
            const SizedBox(width: 8),
            _buildStatItem('Overall Rating', stats['overallRating'].toStringAsFixed(1), Icons.star_rate_rounded, Colors.amber),
            const SizedBox(width: 8),
            _buildStatItem('Patient Reviews', stats['totalPatientFeedback'].toString(), Icons.people_alt_rounded, Colors.green),
            const SizedBox(width: 8),
            _buildStatItem('Doctor Reviews', stats['totalDoctorFeedback'].toString(), Icons.medical_services_rounded, Colors.purple),
          ],
        ),
      );
    },
                ...
                style: TextStyle(
                  ...
                  color: isRating && numericValue != null
                      ? (numericValue >= 4.0 ? Colors.green : 
                         numericValue >= 3.0 ? Colors.amber : Colors.red)
                      : Colors.grey[900],
                  fontFamily: 'Roboto',
                ),
              ),
          ...
          if (isRating && numericValue != null && numericValue > 0) ...[
            ...
            Row(
              ...
              children: List.generate(5, (index) {
                return Icon(
                  index < numericValue.round() ? Icons.star_rounded : Icons.star_border_rounded,
                  size: 8,
                  color: Colors.amber,
                );
              }),
          ...
          items: [
            BottomNavigationBarItem(
              icon: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: _selectedIndex == 0 ? const Color(0xFF18A3B6).withOpacity(0.1) : Colors.transparent,
                ),
                child: Icon(
            ...
            BottomNavigationBarItem(
              icon: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: _selectedIndex == 1 ? const Color(0xFF18A3B6).withOpacity(0.1) : Colors.transparent,
                ),
                child: Icon(
                  _selectedIndex == 1 ? Icons.settings_rounded : Icons.settings_outlined,
                  size: 22,
                ),
              ),
              label: 'Settings',
            ...
            BottomNavigationBarItem(
              icon: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: _selectedIndex == 2 ? const Color(0xFF18A3B6).withOpacity(0.1) : Colors.transparent,
                ),
                child: Icon(
                  _selectedIndex == 2 ? Icons.feedback_rounded : Icons.feedback_outlined,
                  size: 22,
                ),
              ),
              label: 'Feedback',

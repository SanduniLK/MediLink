...
class DoctorProfileScreeen extends StatefulWidget {
  final String doctorId;
  final Map<String, dynamic> doctorData;
  
  const DoctorProfileScreeen({
    super.key,
  ...
  @override
  State<DoctorProfileScreeen> createState() => _DoctorProfileScreenState();
}

class _DoctorProfileScreenState extends State<DoctorProfileScreeen> {
